...
The foreground data is collected from various online sources and combined with background data from the Ecoinvent v3 database by @wernet2016ecoinvent and from the UVEK LCI database DQRv2:2025 database by @FOEN2025. The environmental impact is assessed using the mid-point level Environmental Footprint (EF) method recommended in @ec2021EF, and the Ecological Scarcity 2021 v1.04 method defined in @FOEN2021 at the single score level (with UVEK LCI weighting set). The LCIA is performed using the SimaPro 9.6.0.1 software provided by @SimaPro2024. 
...
![Comparison to other energy sources for district heating (wood chips, heatpump) and consumer installations (gas, oil), based on the Ecological Scarcity 2021 v1.04 method with UVEK LCI weighting set at the single score level.](img/pwrg_solar_es_single_score.png){#fig-es-single-score width="100%"}
...
![Relative influence of the system components using the Ecological Scarcity 2021 v1.04 method with UVEK LCI weighting set at the single score level.](img/pwrg_solar_network_pie.png){#fig-network-pie width="100%"}
