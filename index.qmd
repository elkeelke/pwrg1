...
Again, @fig-ef-midpoints provides the individual results for the most relevant damage categories. These confirm that oil and gas boilers have a very high impact in the damage category climate change (which is equivalent to global warming in the Ecological Scarcity method), and reveals that they the highest in fossil resource use. District heating with wood chips as the energy source has the relative worst impact in three categories: marine eutrophication, land use, and particulate matter (PM). While the latter was visible in @fig-es-single-score and has a sizable impact on the overall single score, the former two have no significant effect in the single score results provided in @fig-es-single-score. The district heating systems with solar thermal based and geothermal energy source have the highest results for the metal and minerals resource use.
