...
![Relative environmental impact of Bracht community district heating network system components using the Ecological Scarcity 2021 v1.04 method at the single score level, using the UVEK LCI weighting set.](img/pwrg_solar_network_bar.png){#fig-network-pie width="50%"}
...
![Relative  environmental impact of Bracht community district heating network system components using the Environmental Footprint Method](img/pwrg_solar_ef_network_bar_faceted.png){#fig-ef-network-pie width="80%"}
