...
The goal and scope definition of an LCIA provides a description of the product system and its system boundaries, and a functional unit.
...
Additional LCI details for all components are provided in the Supporting Information appendix (@sec-lci). The detailed specifications and parameters of the resulting system model are described in section @sec-sima. The remainder of this section outlines the key assumptions regarding component lifetimes, expected electricity demand, and thermal loss coefficients.
