...
The system model, as detailed in @sec-sima, was implemented using SimaPro version 9.6.0.1 @SimaPro2024. This model served as the foundation for generating LCIA results using two established methodologies: the Environmental Footprint (EF) method @ec2021EF and the Ecological Scarcity 2021 v1.04 method @FOEN2021. The corresponding results derived from these assessments are presented in this section.
...
To address the first research question regarding the environmental impact of the additional electricity and the supplemental biomass burnt in the wood boiler, the relative influence of the individual components of the solar thermal district heating system on overall environmental impact was evaluated using the Ecological Scarcity 2021 (version 1.04) method. The assessment was conducted at the single-score level, applying the UVEK LCI weighting set to define the relative importance of the different damage categories. The results are presented in @fig-network-pie. 

Although the solar thermal collectors account for two-thirds of the total energy production (see @fig-bracht-overview), their relative contribution to the overall environmental impact is less than 15%. In contrast, the biomass and electricity sourced from the ENTSO-E production mix (as described in @sec-lci-overview) supply only one-third of the energy delivered to end consumers, but are responsible for approximately two-thirds of the environmental impact. 
