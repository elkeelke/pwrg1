...
As summarized in @werner2017international, the relevant parameters affecting heat loss in the pipes are the (2) length of the network which depends on the transmission distance relative to demand, the (2) system age, and the (3) operating temperature. The cited relevant loss coefficient numbers range between 5% and 35%. The Bracht setup has a long transmission distance of 8.800 meters because of the rural setup. The supply temperature is planned to be set to 85 °C, which is a high supply temperature that will lead to higher losses. Modern systems can achive lower supply temperatures between 50 and 70 °C @Lund2020DistrictHeating to minimize heat losses. 

The rationale for the chosen default of 20% was that the long transmission distance and the high operating temperature will both affect performance negatively.

Both of these factors affect performance negatively. Therefore, even if the system is brand new and therefore modern, assuming a 20% heat loss for the given modeling is a realistic number. 
