...
ggplot(long_ef_normalized, aes(x = Type, y = pct, fill = Type)) +
  ...
  theme(
    ...
    strip.text.y.left = element_text(angle = 90, size = 9, hjust = 0.5, vjust = 0.5), 
...
ggplot(data, aes(x = "", y = Value, fill = Component)) +
  ...
  theme(axis.text.x = element_blank(),  # Hide x-axis labels
        ...
        legend.title = element_text(size = 12),  # Title of the legend
        legend.text = element_text(size = 10)    # Items in the legend
        )  + # Remove border
